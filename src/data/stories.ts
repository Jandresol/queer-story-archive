...
export const stories: StoryProps[] = [
  {
    ...
    song: "seoul by RM",
    excerpt: "Fighting for Asian American students at Harvard.",
    year: "Class of 2025",
  ...
  },
  {
    ...
    Jama has held leadership roles as Co-President of the Harvard Undergraduate Foreign Policy Initiative (HUFPI). He has been a Mellon Mays Fellow and a Radcliffe Research Fellow for the past three years. He also works as a Student Worker for Harvard College’s Office of BGLTQ Student Life, where he has organized events with the Winner of RuPaul's Drag Race - Nymphia Wind, Jeremy Pope, and Representative Mark Takano '83 (D-CA 39th). Additionally, he is an active member of the Institute of Politics and Harvard Men’s Club Volleyball.

    Jama has also worked with the U.S. Department of State for the past two years, focusing on human rights issues in Latin America and the Caribbean. His senior thesis, "Decriminalizing ‘Buggery’ Laws in the Postcolonial Anglophone Caribbean," provides a comparative analysis of efforts to repeal colonial-era anti-LGBTQ+ laws across the Caribbean, examining their relationship to contemporary transnational networks`,
    name: "Jama",
    song: "Never Enough - Loren Allred",
    excerpt: "Challenging Political and Institutional Frameworks",
    year: "Class of 2025",
    identity: `I was raised in Jamaica, a place where non-normative identities are both hyper-visible and strategically erased—where colonial-era laws continue to criminalize intimacy and self-expression, reinforced not just by statutes but by silence. As someone born in the United States but raised in the Caribbean, I’ve always inhabited a space in between: neither fully protected by privilege nor fully disempowered by marginalization. My identity has never operated in isolation—it is shaped by race, class, being a first-generation student, and a religious upbringing that taught both belonging and exclusion.

A pivotal moment came when I began working alongside Caribbean scholars and activists like Professor Tracy Robinson and Matthew Chin. Through their work, I came to understand that the criminalization of people like me wasn’t inevitable but manufactured—imposed through colonial rule and later defended in the name of national respectability. That insight gave language to something I had long felt: my life was not a contradiction to be resolved but a history to be reclaimed. I stopped seeking to reconcile disparate parts of myself and instead began to mobilize them as tools for justice.

Over time, my understanding of identity has become less about self-definition and more about structural intervention. It is not just a matter of who I am, but how I engage the world—how I advocate, how I craft policy, how I imagine freedom. My lived experience has become the framework through which I interrogate power and push institutions to reckon with the histories they obscure.
`,
    harvard: `Harvard has been both a proving ground and a battleground. It grants prestige while demanding constant translation. In classrooms, I’ve often had to contextualize legal and historical frameworks for peers unfamiliar with postcolonial realities. The institution celebrates diversity rhetorically, but often resists the kind of discomfort that real inclusion requires. Navigating Harvard as someone with my background means constantly justifying the stakes of issues others have the privilege to overlook.

Still, I’ve found strength in community—especially among other students of color whose identities, like mine, exist at the intersection of personal history and political urgency. The spaces where I feel most seen are the ones that value both vulnerability and strategy—spaces where people know how to turn shared experience into collective power.

My advocacy has been rooted in both policy and presence—from coordinating with civil society leaders in the Caribbean and the UK to giving a ted-talk style speech at the Institute of Politics. To me, advocacy is not about visibility alone—it’s about accountability and redistribution. It’s about challenging the systems that render our experiences peripheral.

What I wish more students and administrators understood is this: people like me are not just enduring institutions like Harvard—we are reshaping them. We should not have to translate our existence into theory in order to be respected. Institutions should not just tolerate our presence; they should rise to meet our vision.
`,
